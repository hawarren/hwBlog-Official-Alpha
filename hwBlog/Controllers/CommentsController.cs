...
namespace hwBlog.Controllers
{
	...
	public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PostId,AuthorId,Author,Body,Created,Updated,UpdateReason")] Comment comment)
        {
            ...
            //return View(comment);
            return RedirectToAction("Details", "BlogPost");
        }
